  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <h1 style={{ fontSize: '32px', margin: 0 }}>Худалдаа</h1>
        <Button
          type="primary"
          icon={<EnvironmentOutlined />}
          size="large"
          onClick={() => navigate('/user/real-estate-map?type=sale')}
        >
          Газрын зураг дээр харах
        </Button>
      </div>
      <PropertyFilter type="sale" onFilter={handleFilter} />
      <PropertyList properties={properties} type="sale" />
    </div>
  );
};
